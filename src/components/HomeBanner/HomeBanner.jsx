...
const HomeBanner = () => {
  return (
    <section className='main-home min-h-[103vh] relative m-0'>
        <div className='max-w-screen-2xl  px-5  xsm:px-[40px] lg:px-[80px] xll:px-[140px]'>
    ...
    transition={{ duration: 1, type: 'easeInOut' }} className="right flex relative items-center justify-center flex-1">
                {/* <img src={heroimg} alt='Product images' className='max-w-[550px] hnd-rotate left-32 absolute z-0 h-auto' /> */}
