...
const BgNavbar = () => {
  ...
  return (
    <header className={`px-[1rem] fixed top-0 left-0  w-full  z-[100] sm:px-[2rem] max mx-auto h-auto py-[1rem]  backdrop-blur-lg shadow-md flex justify-between items-center  bg-blue-600 `}>
