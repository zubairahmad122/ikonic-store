...
const Footer = () => {
  ...
  return (
   ...
   <div className="main-upper max-md:flex-col flex px-5 xsm:px-[100px] pt-[100px] pb-[40px] gap-[20px] justify-between items-start">
  {/* .left  */}
  ...
  {/* .right  */}
  <div className='max-md:w-full flex flex-col max-md:items-center justify-center'> 
  <h2 className='text-[20px] mb-3 font-medium'>Subscribe</h2>
 ...
 <button className='px-7 py-3 bg-[#0274be] hover:bg-blue-700 duration-200 w-[150px] ease-linear mt-5 rounded-sm font-medium tracking-wide text-white'>Subscribe</button>
     ...
     <hr className='bg-[#1818187a] mx-auto text-center h-[1px] w-[80%] border-none' />
     <div className='w-full h-full  px-5 xsm:px-[100px] py-5 flex items-center justify-center  md:justify-between flex-wrap'>
